...
const String iSubUnit = "sub_unit";
...
const String iShopName = "Shop_name";
const String iSellerId = "Seller_Id";
const String iSellingType = "selling_type";
const String iQuantityAsPrice = "quantity_per_price";